...
import jsparts from '../assets/js.png';
...
export default class Presentation extends React.Component {
  render() {
    return <Deck transition={["zoom", "slide"]} transitionDuration={500} theme={theme}>
        ...
        <Slide transition={["fade"]}>
          ...
          <CodePane lang="typescript" theme="dark" source={`class Object {
  attribute: string;
  ...
  protected methdod1() {
    ...
        ...
        <Slide transition={["fade"]}>
          ...
          <CodePane lang="typescript" theme="dark" source={`abstract class Object {
  public readonly url = '127.0.0.1';
        ...
        <Slide transition={["fade"]}>
          ...
          <CodePane lang="typescript" theme="dark" source={`const fn = <T>(arg: T): Array<T> => [arg];
...
`} />
        ...
        <Slide transition={["fade"]}>
          ...
          <CodePane lang="typescript" theme="dark" source={`interface Developer {
  name: string;
  ...
  code(lang: string) {
    return 'TypeScript';
        ...
        <Slide transition={["fade"]}>
          ...
          <CodePane lang="typescript" theme="dark" source={`enum Response {
  No = 0,
  Yes = 1,
}
...
`} />
        ...
        <Slide transition={["fade"]}>
          ...
          <CodePane lang="python" theme="dark" source={`tsc main.js --allowJs --checkJs --out /dev/null`} />
        </Slide>
        ...
        <Slide transition={["fade"]}>
          ...
          <CodePane lang="python" theme="dark" source={`for f in src/**/*.js; do
  git mv "$f" "\${f%.js}.ts"
done
`} />
        </Slide>
        ...
        <Slide transition={["fade"]} bgColor="primary" textColor="tertiary">
          ...
          <Table>
            <TableBody>
              <TableRow>
                <TableItem>
                  <CodePane lang="typescript" source={`const fn = (): number => 42;
...
`} />
                ...
                <TableItem>
                  <CodePane lang="typescript" source={`const fn = () => 42;
const variable = '';
...
`} />
        ...
        <Slide transition={["fade"]}>
          ...
          <CodePane lang="typescript" theme="dark" source={`const fn = (arg: string | number) => {
...
`} />
        ...
        <Slide transition={["fade"]}>
          ...
          <CodePane lang="typescript" theme="dark" source={`type AliasType = Array<{ [key: string]: [number, string, boolean] }>`} />
        </Slide>
        ...
        <Slide transition={["fade"]}>
          ...
          <CodePane lang="typescript" theme="dark" source={`const fn = (explicite: any, implicite) => {
  explicite *= 42;
  implicite.map(i => i + 2);
...
`} />
        ...
        <Slide transition={["fade"]}>
          ...
          <CodePane lang="json" theme="dark" source={`"noUnusedParameters": true,
"noUnusedLocals": true,
`} />
          <hr />
          <CodePane lang="typescript" theme="dark" source={`const fn = (arg: number) => { // ERROR
...
fn(42, str => str / 2); // ERROR`} />
        ...
        <Slide transition={["fade"]}>
          ...
          <CodePane lang="typescript" theme="dark" source={`const fn = (arg: number, arg1: (string) => string) => {}
...
fn(42, str => str / 2); // ERROR`} />
        ...
        <Slide transition={["fade"]}>
          ...
          <CodePane lang="typescript" theme="dark" source={`function fn() {
  ...
  method() {
    ...
    function fn() {
      console.log(this); // 'this' implicitly has type 'any' because it does not have a type annotation.
        ...
        <Slide transition={["fade"]}>
          ...
          <CodePane lang="typescript" theme="dark" source={`const fn = () => {
    if (true) {
    ...
    return 42;
        ...
        <Slide transition={["fade"]}>
          ...
          <CodePane lang="typescript" theme="dark" source={`// WRONG
const fn = (arg) => arg;
...
[1,2,3].map(item => item + 1);`} />
        ...
        <Slide transition={["fade"]}>
          ...
          <CodePane lang="typescript" theme="dark" source={`document.querySelector('#id').getAttribute('class') // ERROR;
...
if (element !== null) {
  element.getAttribute('#id');
        ...
        <Slide transition={["fade"]}>
          ...
          <CodePane lang="json" theme="dark" source={`"strictPropertyInitialization": true,
...
`} />
        ...
        <Slide transition={["fade"]}>
          ...
          <CodePane lang="typescript" source={`type If<A extends boolean, T, U> = A extends true ? T : U;
...
let b: If<false, string, number>; // number`} />
        ...
        <Slide transition={["fade"]}>
          ...
          <CodePane lang="typescript" source={`export type ReadonlyObject<A> = { readonly [K in keyof A]: <A[K]> };
type DeepReadonlyObject<A> = { readonly [K in keyof A]: DeepReadonly<A[K]> }

type X = DeepReadonlyObject<{ key: string, key1: number }>; // { readonly key: any; readonly key1: number; }
`} />
        </Slide>
        <Slide transition={["fade"]}>
          <Heading size={6} textColor="secondary">
          ...
          <CodePane lang="typescript" source={`export type Omit<A extends object, K extends string | number | symbol> = Pick<A, Exclude<keyof A, K>>
...
type Diff<A extends object, K extends keyof A> = Omit<A, K> & Partial<Pick<A, K>>`} />
        ...
        <Slide transition={["fade"]}>
          ...
          <CodePane lang="typescript" source={`type ZeroTuple = [];
...
type T = Increment<42>`} />
        ...
        {/* <Slide>
          ...
          <List>
            <ListItem textSize="20">
              <a href="https://github.com/SonarSource/SonarTS">
                Sonar to TS
              </a>
            </ListItem>
            <ListItem textSize="20">
              <a href="https://github.com/gcanti/typelevel-ts">
                TS type utils
              </a>
            </ListItem>
            <ListItem textSize="20">
        ...
        {/* <Slide transition={["fade"]}>
          ...
          <CodePane lang="typescript" source={`export interface Type<T> extends Function {
  new (...args: any[]): T;
}
